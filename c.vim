...
syn keyword	cConstant		O_ACCMODE
syn keyword	cConstant		O_RDONLY
syn keyword	cConstant		O_WRONLY
syn keyword	cConstant		O_RDWR
syn keyword	cConstant		O_CREAT
syn keyword	cConstant		O_EXCL
syn keyword	cConstant		O_NOCTTY
syn keyword	cConstant		O_TRUNC
syn keyword	cConstant		O_APPEND
syn keyword	cConstant		O_NONBLOCK
syn keyword	cConstant		O_NONBLOCK
syn keyword	cConstant		O_SYNC
syn keyword	cConstant		O_SYNC
syn keyword	cConstant		O_ASYNC
"--------------------------------------------------------------------
...
syn keyword	cSysFunc		ftrylockfile
syn keyword	cSysFunc		funlockfile
syn keyword	cSysFunc		dlopen dlclose dlsym dlerror

syn keyword	zyLibFunc		CALLOC REALLOC MALLOC FREE
